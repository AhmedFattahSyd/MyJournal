...
export default class MpgItem extends MpgRootItem {
  ...
  private parkedDueTime: Date = new Date()
  //////////////////////////////////////////////////////////////////////////////////////////////////////////
  // constructor
  //////////////////////////////////////////////////////////////////////////////////////////////////////////
  constructor(
  ...
  park = (mins: number)=>{
    ...
    this.parkedDueTime = now
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // get parking due time
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  getParkingDueTime = () => {
    return this.parkedDueTime
  }
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // get time to get active
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  getTimeToBeActive = () : number =>{
      return ((new Date()).getTime() - this.parkedDueTime.getTime())/(1000 * 60)
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // reset parking state
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  resetParkingState = () => {
    if(this.state === ItemState.Parked){
      if(new Date() > this.parkedDueTime){
        this.state = ItemState.Active
        this.parkedDueTime = new Date()
      }
    }
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
