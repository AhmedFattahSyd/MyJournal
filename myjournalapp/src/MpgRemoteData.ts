...
export class MpgRemoteData {
        ...
        try{
            ...
            if(statusCode == 200){
                ...
                if (mpgDataResponse.returnCode == MpgData.MpgDataServerReturnCode.Success) {
                    ...
                    // error from dynamoDB
                    // this.mpgLogger.debug("MpgClientData: createItemrecord: eroror from DynamoDB:",mpgDataResponse.msg)
    ...
    public loadData = async() => {
        try{
            ...
            this.mpgLogger.unexpectedError(error,'MpgClientData: loadData: Error:  ');
        }
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    // wait
        ...
        try{
            ...
            if(statusCode == 200){
                ...
                if (mpgDataResponse.returnCode == MpgData.MpgDataServerReturnCode.Success) {
                    ...
                    // error from dynamoDB
                    this.mpgLogger.debug("MpgClientData: deleteItemrecord: eroror from DynamoDB:",mpgDataResponse.msg)
            ...
            this.mpgLogger.unexpectedError(error,'MpgGraph: deleteItemRecortd: Error:  ');
        }
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    // update item record
    ...
    public updateItemRecord = async (updatedItemRecord: MpgData.MpgItemRecord) => {
        ...
        try{
            let cred = await Auth.currentCredentials()
                ...
                if(statusCode == 200){
                    ...
                    if (mpgDataResponse.returnCode == MpgData.MpgDataServerReturnCode.Success) {
                        ...
                        // error from dynamoDB
                        this.mpgLogger.debug("MpgClientData: updateItemrecord: eroror from DynamoDB:",mpgDataResponse.msg)
            ...
            this.mpgLogger.unexpectedError(error,"MpgClientData: updateItem: error:");
        }
    }
}